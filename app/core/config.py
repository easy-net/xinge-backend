...
class Settings:
    ...
    wechat_virtual_goods_price: int = 9900            # 微信虚拟支付后台道具单价（分）
    ...
    def missing_virtual_payment_fields(self):
        fields = {
            ...
            "WECHAT_VIRTUAL_GOODS_PRICE": self.wechat_virtual_goods_price,
        }
        return [key for key, value in fields.items() if not value]
...
def get_settings() -> Settings:
    return Settings(
        ...
        wechat_virtual_goods_price=int(os.getenv("WECHAT_VIRTUAL_GOODS_PRICE", "9900")),

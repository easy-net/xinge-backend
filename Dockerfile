...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    WECHAT_NOTIFY_URL=https://xinge-backend-249835-4-1417316089.sh.run.tcloudbase.com/api/v1/payments/notify \
    WECHAT_TRANSFER_NOTIFY_URL=https://xinge-backend-249835-4-1417316089.sh.run.tcloudbase.com/api/v1/payments/transfer/notify \
